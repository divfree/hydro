...
EXTERNC INTEGER4 STDCALL TECNOD142(INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECNODE142(
    INTEGER4 const* N,
    INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECEND142(void);

EXTERNC INTEGER4 STDCALL TECLAB142(char const* S);

EXTERNC INTEGER4 STDCALL TECUSR142(char const* S);

EXTERNC INTEGER4 STDCALL TECGEO142(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
...
EXTERNC INTEGER4 STDCALL TECTXT142(
...
EXTERNC INTEGER4 STDCALL TECFIL142(INTEGER4 const* F);

EXTERNC void STDCALL TECFOREIGN142(INTEGER4 const* OutputForeignByteOrder);

EXTERNC INTEGER4 STDCALL TECAUXSTR142(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECZAUXSTR142(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECVAUXSTR142(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC INTEGER4 STDCALL TECFACE142(INTEGER4 const* FaceConnections);

EXTERNC INTEGER4 STDCALL TECPOLY142(
...
EXTERNC INTEGER4 STDCALL TECPOLYFACE142(
...
EXTERNC INTEGER4 STDCALL TECPOLYBCONN142(
...
EXTERNC INTEGER4 STDCALL TECINI112(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC INTEGER4 STDCALL TECZNE112(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC INTEGER4 STDCALL TECDAT112(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC INTEGER4 STDCALL TECNOD112(INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECNODE112(
    INTEGER4 const* N,
    INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECEND112(void);

EXTERNC INTEGER4 STDCALL TECLAB112(char const* S);

EXTERNC INTEGER4 STDCALL TECUSR112(char const* S);

EXTERNC INTEGER4 STDCALL TECGEO112(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECTXT112(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECFIL112(INTEGER4 const* F);

EXTERNC void STDCALL TECFOREIGN112(INTEGER4 const* OutputForeignByteOrder);

EXTERNC INTEGER4 STDCALL TECAUXSTR112(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECZAUXSTR112(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECVAUXSTR112(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC INTEGER4 STDCALL TECFACE112(INTEGER4 const* FaceConnections);

EXTERNC INTEGER4 STDCALL TECPOLY112(
    INTEGER4 const* FaceNodeCounts,
    INTEGER4 const* FaceNodes,
    INTEGER4 const* FaceLeftElems,
    INTEGER4 const* FaceRightElems,
...
EXTERNC INTEGER4 STDCALL TECPOLYFACE112(
    INTEGER4 const* NumFaces,
    INTEGER4 const* FaceNodeCounts,
    INTEGER4 const* FaceNodes,     
    INTEGER4 const* FaceLeftElems, 
...
EXTERNC INTEGER4 STDCALL TECPOLYBCONN112(
    INTEGER4 const* NumBndryFaces,
    INTEGER4 const* FaceBndryConnectionCounts,
    INTEGER4 const* FaceBndryConnectionElems, 
    INTEGER4 const* FaceBndryConnectionZones);
...
EXTERNC INTEGER4 STDCALL TECINI111(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC INTEGER4 STDCALL TECZNE111(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC INTEGER4 STDCALL TECDAT111(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC INTEGER4 STDCALL TECNOD111(INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECEND111(void);

EXTERNC INTEGER4 STDCALL TECLAB111(char const* S);

EXTERNC INTEGER4 STDCALL TECUSR111(char const* S);

EXTERNC INTEGER4 STDCALL TECGEO111(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECTXT111(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECFIL111(INTEGER4 const* F);

EXTERNC void STDCALL TECFOREIGN111(INTEGER4 const* OutputForeignByteOrder);

EXTERNC INTEGER4 STDCALL TECAUXSTR111(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECZAUXSTR111(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECVAUXSTR111(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC INTEGER4 STDCALL TECFACE111(INTEGER4 const* FaceConnections);

EXTERNC INTEGER4 STDCALL TECPOLY111(
    INTEGER4 const* FaceNodeCounts,
    INTEGER4 const* FaceNodes,
    INTEGER4 const* FaceLeftElems,
    INTEGER4 const* FaceRightElems,
...
EXTERNC INTEGER4 STDCALL TECINI110(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC INTEGER4 STDCALL TECZNE110(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC INTEGER4 STDCALL TECDAT110(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC INTEGER4 STDCALL TECNOD110(INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECEND110(void);

EXTERNC INTEGER4 STDCALL TECLAB110(char const* S);

EXTERNC INTEGER4 STDCALL TECUSR110(char const* S);

EXTERNC INTEGER4 STDCALL TECGEO110(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECTXT110(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC void STDCALL TECFOREIGN110(INTEGER4 const* OutputForeignByteOrder);

EXTERNC INTEGER4 STDCALL TECFIL110(INTEGER4 const* F);

EXTERNC INTEGER4 STDCALL TECAUXSTR110(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECZAUXSTR110(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECVAUXSTR110(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC INTEGER4 STDCALL TECFACE110(INTEGER4 const* FaceConnections);
...
EXTERNC INTEGER4 STDCALL TECINI100(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC INTEGER4 STDCALL TECZNE100(
    char const*     ZoneTitle,
    INTEGER4 const* ZoneType,
    INTEGER4 const* IMxOrNumPts,
    INTEGER4 const* JMxOrNumElements,
...
EXTERNC INTEGER4 STDCALL TECDAT100(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC INTEGER4 STDCALL TECNOD100(INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECEND100(void);

EXTERNC INTEGER4 STDCALL TECLAB100(char const* S);

EXTERNC INTEGER4 STDCALL TECUSR100(char const* S);

EXTERNC INTEGER4 STDCALL TECGEO100(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECTXT100(
    double const*   XOrThetaPos,
    double const*   YOrRPos,
    double const*   ZOrUnusedPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECFIL100(INTEGER4 const* F);

EXTERNC void STDCALL TECFOREIGN100(INTEGER4 const* OutputForeignByteOrder);

EXTERNC INTEGER4 STDCALL TECAUXSTR100(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECZAUXSTR100(
    char const* Name,
    char const* Value);

EXTERNC INTEGER4 STDCALL TECVAUXSTR100(
    INTEGER4 const* Var,
    char const*     Name,
    char const*     Value);

EXTERNC INTEGER4 STDCALL TECFACE100(INTEGER4 const* FaceConnections);

/* Old V9 functions retained for backward compatibility */

EXTERNC INTEGER4 STDCALL TECINI(
    char const*     Title,
    char const*     Variables,
    char const*     FName,
    char const*     ScratchDir,
...
EXTERNC INTEGER4 STDCALL TECZNE(
    char const*     ZoneTitle,
    INTEGER4 const* IMx,
    INTEGER4 const* JMx,
    INTEGER4 const* KMx,
...
EXTERNC INTEGER4 STDCALL TECDAT(
    INTEGER4 const* N,
    void const*     FieldData,
    INTEGER4 const* IsDouble);

EXTERNC INTEGER4 STDCALL TECNOD(INTEGER4 const* NData);

EXTERNC INTEGER4 STDCALL TECEND(void);

EXTERNC INTEGER4 STDCALL TECLAB(char const* S);

EXTERNC INTEGER4 STDCALL TECUSR(char const* S);

EXTERNC INTEGER4 STDCALL TECGEO(
    double const*   XPos,
    double const*   YPos,
    double const*   ZPos,
    INTEGER4 const* PosCoordMode,
...
EXTERNC INTEGER4 STDCALL TECTXT(
    double const*   XPos,
    double const*   YPos,
    INTEGER4 const* PosCoordMode,
    INTEGER4 const* AttachToZone,
...
EXTERNC INTEGER4 STDCALL TECFIL(INTEGER4 const* F);
